...
export function GridTileImage({
  ...
  active?: boolean; // selection (used by gallery)
  available?: boolean; // inventory availability (explicit)
  label?: {
    title: string;
    amount: string;
    currencyCode: string;
  ...
  return (
    ...
    >
      ...
      {/* Inventory badge - only show when availability is explicitly false */}
      {available === false ? (
